...
namespace UnityEditor.OdnoklassnikiEditor
{
	public class ManifestMod
	{
		public const string DeepLinkingActivityName = "ru.odnoklassniki.unity.OKDeepLinkingActivity";

		public const string LoginActivityName = "ru.odnoklassniki.LoginActivity";

		public const string UnityLoginActivityName = "ru.odnoklassniki.unity.OKUnityLoginActivity";

		public const string UnityDialogsActivityName = "ru.odnoklassniki.unity.OKUnityDialogsActivity";

		public const string ApplicationIdMetaDataName = "ru.odnoklassniki.sdk.ApplicationId";

		public static void GenerateManifest()
		{
			//TODO: Fix manifest merge
		...
		public static bool CheckManifest()
		{
			...
			if (!File.Exists(outputFile))
			{
				Debug.LogError("An android manifest must be generated for the Odnoklassniki SDK to work.  Go to Odnoklassniki->Edit Settings and press \"Regenerate Android Manifest\"");
				return false;
			}
			...
			{
				Debug.LogError(string.Format("{0} is missing from your android manifest.  Go to Odnoklassniki->Edit Settings and press \"Regenerate Android Manifest\"", LoginActivityName));
				result = false;
			}

			var deprecatedMainActivityName = "ru.odnoklassniki.unity.OKUnityPlayerActivity";
			...
			{
				Debug.LogWarning(string.Format("{0} is deprecated and no longer needed for the Odnoklassniki SDK.  Feel free to use your own main activity or use the default \"com.unity3d.player.UnityPlayerNativeActivity\"", deprecatedMainActivityName));
			}
		...
		{
			string appId = OKSettings.AppId;

			if (!OKSettings.IsValidAppId)
			{
				Debug.LogError("You didn't specify a Odnoklassniki app ID.  Please add one using the Odnoklassniki menu in the main Unity editor.");
				return;
			}
			...
			//add the app id
			//<meta-data android:name="ru.odnoklassniki.sdk.ApplicationId" android:value="\ 409682555812308" />
		...
		{
			//<activity android:name="ru.odnoklassniki.LoginActivity" android:configChanges="keyboardHidden|orientation" android:theme="@android:style/Theme.Translucent.NoTitleBar.Fullscreen">
			//</activity>
		...
		{
			//<activity android:name="ru.odnoklassniki.unity.OKDeepLinkingActivity" android:exported="true">
			//</activity>
			XmlElement activityElement = doc.CreateElement("activity");
